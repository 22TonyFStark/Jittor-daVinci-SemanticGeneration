    ...
    def __getitem__(self, index):
        ...
        # if 0:
            ...
            if self.opt.phase != 'test':
                ...
                key = label_path.replace('\\', '/').split('DeepFashion/')[-1] if self.opt.dataset_mode == 'deepfashion' else os.path.basename(label_path)
            
            val = self.ref_dict[key.replace("jpg","png")]
            ...
            image_ref = Image.open(path_ref.replace("png","jpg")).convert('RGB')
            ...
            self_ref_flag = jittor.zeros_like(ref_tensor)
            self_ref_flag.stop_grad()
        ...
        # if 1:
            ...
            self_ref_flag = jittor.ones_like(ref_tensor)
