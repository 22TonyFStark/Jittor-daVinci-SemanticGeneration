...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--dists_w', type=float, default=12.5, help='weight for dists loss')
        
        parser.add_argument('--skip_corr', action='store_true', help='weight for marginal contrastive loss')
