...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--im_height', type=int, default=192, help='Crop to the width of crop_size (after initially scaling the images to load_size.)')
        parser.add_argument('--im_width', type=int, default=256, help='Crop to the width of crop_size (after initially scaling the images to load_size.)')
        ...
        # for setting inputs
        parser.add_argument('--trainimg_root', type=str, default='/mnt/blob/Dataset/ADEChallengeData2016/images')
        
        parser.add_argument('--dataroot', type=str, default='/mnt/blob/Dataset/ADEChallengeData2016/images')
        parser.add_argument('--dataset_mode', type=str, default='scene')
